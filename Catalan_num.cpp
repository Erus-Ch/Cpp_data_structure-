// Non-recursive Catalan Numbers Enumeration
/* The program calculates nth Catalan number using Dynamic programming.
...
// This function returns to nth catalan number
